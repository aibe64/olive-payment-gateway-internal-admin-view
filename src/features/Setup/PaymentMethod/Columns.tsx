...
export const paymentMethodColumn: ColumnProps<APIResponse.PaymentMethod>[] = [
  {
    title: "Date Created",
    width: "20%",
    key: "1",
      ...
      return (
        <div className="flex flex-col">
          <span className="font-inter-semibold">
            {Format.toNaira(String(record.defaultCharge ?? "0.00"))}
          </span>
        </div>
      );
    },
  },
  {
    ...
    render(_, record) {
      return (
        <div className="flex flex-col">
          <span className="font-inter-semibold">
            {Format.toNaira(String(record.chargeCap ?? "0.00"))}
          </span>
        </div>
      );
    },
  ...
  },
  {
    ...
    fixed: "right",
    width: "80px",
    render(_: any, record: APIResponse.PaymentMethod) {
      return (
        <XpressTableActions
          record={record}
